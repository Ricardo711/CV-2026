    ...
    <div class="mx-auto space-y-4 p-4">
            ...
            <template v-else-if="gs.session.value">
                ...
                <template v-else>
                    <!-- Progress indicator -->
                    <RoundProgress
                        :current-round="gs.currentRound.value"
                    ...
                    <Game1Round
                        v-if="gs.currentGameType.value === 1"
                        :key="`g1-r${gs.currentRound.value}`"
                        :session-id="gs.sessionId.value!"
                        :round="gs.currentRound.value"
                        @round-complete="gs.onRoundComplete"
                    />
                    <Game3Round
                        v-else-if="gs.currentGameType.value === 3"
                        :key="`g3-r${gs.currentRound.value}`"
                        :session-id="gs.sessionId.value!"
                        :round="gs.currentRound.value"
                        @round-complete="gs.onRoundComplete"
                    />
                    <Game2Round
                        v-else-if="gs.currentGameType.value === 2"
                        :key="`g2-r${gs.currentRound.value}`"
                        :session-id="gs.sessionId.value!"
                        :round="gs.currentRound.value"
                        @round-complete="gs.onRoundComplete"
                    />
